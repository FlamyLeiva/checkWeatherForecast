...
resumen_diferencias_orchards<- resumen_diferencias %>%
  arrange(diferencia_promedio)

resumen_diferencias_total<- resumen_diferencias %>%
  arrange(diferencia_promedio)
...
QUITAR LOS OUTLAYERS Y GRAFICR DENUEVO
PROBAR GRAFICOS DE ACERCAMIENTO O ESTACIONES CERCANAS 

REVISAR ESTACIONES CONMAYOR VARIACIÓN 
```{r}
